...
ELASTIC_SEARCH_HOST = env('ELASTIC_SEARCH_HOST', None)
if ELASTIC_SEARCH_HOST:
    ...
    ELASTIC_SEARCH_SHARDS = env('ELASTIC_SEARCH_SHARDS')
    ELASTIC_SEARCH_REPLICAS = env('ELASTIC_SEARCH_REPLICAS')
    ELASTIC_SEARCH_PIPELINE = env('ELASTIC_SEARCH_PIPELINE', '_none')
